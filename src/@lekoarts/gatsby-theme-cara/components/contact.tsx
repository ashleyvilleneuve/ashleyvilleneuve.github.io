...
import Svg from "./svg"
import { UpDown, UpDownWide, waveAnimation } from "../../../../node_modules/@lekoarts/gatsby-theme-cara/src/styles/animations"
  ...
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <Svg icon="star_a" width={8} stroke color="icon_darkest" left="25%" top="5%" />
      </UpDown>
      <UpDownWide>
        <Svg icon="star_d" width={12} stroke color="icon_brightest" left="95%" top="50%" />
        <Svg icon="star_b" width={6} color="icon_brightest" left="85%" top="15%" />
        <Svg icon="star_c" hiddenMobile width={8} color="icon_darkest" left="45%" top="10%" />
      </UpDownWide>
      <Svg icon="star_b" width={6} color="icon_brightest" left="4%" top="20%" />
      <Svg icon="star_e" width={12} color="icon_darkest" left="70%" top="60%" />
      <Svg icon="star_a" width={12} color="icon_darkest" left="20%" top="30%" />
